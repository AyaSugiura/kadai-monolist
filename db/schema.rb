...
ActiveRecord::Schema.define(version: 20180710004801) do
  ...
  create_table "ownerships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id", "item_id", "type"], name: "index_ownerships_on_user_id_and_item_id_and_type_and_type", unique: true, using: :btree
